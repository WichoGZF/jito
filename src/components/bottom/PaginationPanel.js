...
const paginationContent = [
    {
        ...
        plan your entire day and future days, based on a Pomodoro work-rest scheduled.`
    },
    {
        ...
        You complete them by doing pomodoros until they reach 0. Good for things you only want to spend a fixed ammount on
        \n
        ...
        complete them. If you complete a normal task while the timer has started (before the break starts) an according
        ammount of break time is calculated and you can choose to use it now (break starts) store it for later (next break
        the stored time is used) or discard it. 
        `
    },
    {
        title: `Calendar feature`,
        content: `
        Pomodoro Planner uses the calendar below the timer to plan ahead your tasks. Just click a specific date in the
